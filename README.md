...
> Turkish is an agglutinative language and has a very rich morphological
  ...
  appending a sequence of suffixes. For example The word "doktoruymuþsunuz"
  means "You had been the doctor of him". The stem of the word is "doktor" and
  it takes three different suffixes -sU, -ymUþ, and -sUnUz.
...
8. In Turkish, words do not end with consonants 'b', 'c', 'd', and 'ð'.
   ...
   'd', or 'ð' respectively. The postlude routine transforms last consonants
   'b', 'c','d', or 'ð'' back to 'p', 'ç', 't' or 'k', respectively, after
...
1. Vowel harmony rule for frontness: Vowels in Turkish are grouped into two
   ...
   produced nearer to throat ('a', 'ý', 'o', 'u'). According to the vowel
...
2. Vowel harmony rule for roundness: Vowels in Turkish are grouped into two
   ...
   'ü' are rounded vowels whereas 'a', 'e', 'ý' and 'i' are unrounded.
...
case, a U vowel ('ý', 'i', 'u' or 'ü' depending on vowel harmony) is inserted
...
Çocuðuymuþumcasýna             | As if I were her child
Çocuk-(s)U-(y)mUþ-(y)Um-cAsInA | Çocuk
Kedileriyle                    | With their cats
Kedi-lAr-(s)U-(y)lA            | Kedi
Çocuklarýmmýþ                  | Someone told me that they were my children
çocuk-lAr-(U)m-(y)mUþ          | Çocuk
Kitabýmýzdý                    | It was our book
